...
def main(_):
    ...
    p_net.to(device)
    v_net.to(device)
    optim_p = AdaBound(p_net.parameters(), lr=FLAGS.lr, final_lr=FLAGS.final_lr)
    optim_v = AdaBound(v_net.parameters(), lr=FLAGS.lr, final_lr=FLAGS.final_lr)
    ...
    if FLAGS.use_discrim:
        ...
        optim_discrim = AdaBound(
            list(pseudo_rew_net.parameters()) + list(shaping_val_net.parameters()), lr=FLAGS.lr, final_lr=FLAGS.final_lr
        )
